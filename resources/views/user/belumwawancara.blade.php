...
<body class="d-flex justify-content-center align-items-center vh-100 bg-light">
    ...
    <div class="border border-danger rounded p-5 text-center bg-white shadow" style="max-width: 600px; width: 90%;">
        <h4 class="fw-bold text-dark">Jadwal wawancara belum tersedia, silahkan cek kembali nanti!</h4>
        <img src="{{ asset('images/tandaseru.svg') }}" alt="Menunggu" class="my-3" width="150">
