        ...
        <div class="form-container">
          ...
          <form>
            ...
            <div class="mb-3 position-relative" style="width: 430px;">
              ...
              <!-- Tempat untuk hash password (contoh visual) -->
            ...
            <button type="submit" class="btn btn-light text-primary fw-bold w-100 rounded-3" style="width: 560px;">Masuk</button>
          </form>

          <!-- Link to Sign Up -->
          <p class="signup-text">Jika belum memiliki akun, <a href="{{ route('daftar1') }}">Daftar</a> sekarang!</p>
        </div>
      </div>
    </div>
  </div>
